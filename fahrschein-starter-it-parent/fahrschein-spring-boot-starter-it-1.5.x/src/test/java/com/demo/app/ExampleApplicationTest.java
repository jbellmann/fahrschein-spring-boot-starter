...
public class ExampleApplicationTest {
    ...
    public void contextLoads() throws InterruptedException, IOException, ExecutionException {
        ...
        ResponseEntity<String> response = http.getForEntity("http://localhost:" + managementPort + "/metrics", String.class);
        System.out.println(response.getBody());

//        System.out.println("--- PROMETHEUS ---");
//        response = http.getForEntity("http://localhost:" + managementPort + "/prometheus", String.class);
//        System.out.println(response.getBody());
    }
